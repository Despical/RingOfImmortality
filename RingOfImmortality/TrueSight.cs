...
namespace RingOfImmortality
{
    ...
    internal static class TrueSight
    {
        ...
        public static void DrawOverWorld(SpriteBatch spriteBatch)
        {
            ...
            if (!Context.IsWorldReady || !ModEntry.Instance.RingHandler.HasRingEquipped(ModEntry.Instance.RingHandler.RingTrueSight))
                return;
        ...
        public static int GetMineStoneDrop(int tileIndexOfStone, int x, int y, Farmer player, MineShaft mine)
        {
            ...
            int stonesLeftOnThisLevel = ModEntry.Instance.Helper.Reflection.GetProperty<int>(mine, "stonesLeftOnThisLevel").GetValue();
            bool ladderHasSpawned = ModEntry.Instance.Helper.Reflection.GetField<bool>(mine, "ladderHasSpawned").GetValue();
